    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('mobileNumber', models.CharField(max_length=11, unique=True, validators=[apps.user.validators.mobile_validator.validate_iranian_mobile])),
                ('email', models.EmailField(blank=True, max_length=100, null=True)),
                ('name', models.CharField(blank=True, max_length=60, null=True)),
                ('family', models.CharField(blank=True, max_length=60, null=True)),
